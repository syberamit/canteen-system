...
<style type="text/css">			
	...
	<body>
		...
		<div class="container">
    <h1 class="welcome text-center" align="center" style="color: black"> Hey Welcome<br></h1>
        <div class="card card-container">
        <h2 class='login_title text-center' align="center" style="color: darkgrey">Login using your<br> PRN Number</h2>
			...
			<h2 align="center"><a href="customer_register.php"><button type="button" class="btn btn-success" name="">New? Register Here</button></a></h2>
       			  ...
       			  <p>&copy; 2024&middot; <a href="#"></a> &middot;</p>
